...
.github/
├── scripts/
│   ├── demo-sync-models.sh    # This demo script
│   ├── scrape-models.js        # Production web scraper
│   ├── scrape-models.sh        # Legacy shell-based scraper
│   ├── package.json            # Dependencies (puppeteer)
│   └── DEMO.md                 # This file
└── workflows/
    ├── check-models.yml        # Main workflow definition
    └── prompts/
        └── sync-models-prompt.md  # Instructions for Copilot CLI
```
