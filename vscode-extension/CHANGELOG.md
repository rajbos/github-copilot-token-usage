...
* Add Figma MCP tool friendly names by @Copilot in https://github.com/rajbos/github-copilot-token-usage/pull/682
* Remove PAT login from sharing server by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/683
* fix toolnames discovery by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/684
* Add GitHub Copilot AI-Credit pricing alongside provider pricing by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/685
* chore: bump versions for release (vscode-extension v0.2.1) by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/688
* chore: bump Visual Studio extension to v1.0.10 by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/690
* chore(cli): bump version to v0.0.12 by @github-actions[bot] in https://github.com/rajbos/github-copilot-token-usage/pull/689
* feat: Azure Container Apps deployment for sharing server (Terraform + workflows) by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/677
* feat: scan workspaceStorage debug-logs directories for session files by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/692
* fix: populate dailyRollups for Mistral Vibe and Claude Desktop Cowork sessions by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/693
* feat(sharing-server): add ADMIN_GITHUB_LOGINS for declarative admin management by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/691
* feat(sharing-server): admin token usage dashboard by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/694
* feat: load and log Copilot plan info from copilot_internal/user API by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/687
* Add missing friendly display names for 28 tools by @Copilot in https://github.com/rajbos/github-copilot-token-usage/pull/695
* sharing-server: add admin overview dashboard with aggregate stats and trend chart by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/696
* chore: make test environment cleanup manual-only by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/697
* feat: add deploy_to_test workflow_dispatch input by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/698
* chore: bump versions for release (vscode-extension, cli) by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/699
* chore(cli): bump version to v0.0.14 by @github-actions[bot] in https://github.com/rajbos/github-copilot-token-usage/pull/700
* fix: show Configure Backend button when backend storage info is unavailable by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/701
* feat: add target_app workflow_dispatch input to update named test environments by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/702
* fix: exclude suppressed tools from unknown tools banner by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/704
* feat: add estimated cost view to chart page by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/703
* fix: use esbuild as preLaunchTask so F5 debug always works by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/705
* feat(sharing-server): add deployment footer with version info by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/706
* feat: first-value onboarding empty-state guidance and Scoring Guide panel by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/710
* feat: extract pure stats helpers and add date-boundary contract tests by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/711
* feat: add macOS path support for Claude Desktop Cowork sessions by @Copilot in https://github.com/rajbos/github-copilot-token-usage/pull/714
* chore: bump versions for release (vscode-extension 0.3.0, cli 0.0.14) by @rajbos in https://github.com/rajbos/github-copilot-token-usage/pull/715
...
**Full Changelog**: https://github.com/rajbos/github-copilot-token-usage/compare/cli/v0.0.8...vscode/v0.3.0
