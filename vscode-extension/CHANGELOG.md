...
<!-- Release notes generated using configuration in .github/release.yml at vscode/v0.5.0 -->
...
* fix(release): skip publish if version already live (idempotent re-runs) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/768
* fix(vscode): only suppress deprecation notice on explicit Dismiss by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/770
* feat(vscode): detect legacy extension in new extension and prompt uninstall by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/772
* Add missing friendly display names for 7 tools by @Copilot in https://github.com/rajbos/ai-engineering-fluency/pull/771
* chore: bump versions for release (vscode-extension v0.4.0, cli v0.1.0) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/773
* fix(readme): replace retired vsmarketplacebadges.dev and update extension IDs by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/774
* chore(vscode): bump VS Code extension to v0.4.1 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/776
* fix: add macOS ARM64 support to JetBrains plugin (fixes #775) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/777
* Add friendly names for two missing GitHub MCP (Local) tools by @Copilot in https://github.com/rajbos/ai-engineering-fluency/pull/781
* chore: bump Visual Studio extension to v1.0.12 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/780
* fix: use absolute URL for logo in VS Code extension README by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/782
* Add missing friendly display names for 10 tools by @Copilot in https://github.com/rajbos/ai-engineering-fluency/pull/784
* fix: team dashboard empty by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/783
* fix: break curl|python3 pipe to resolve pinned-dependencies alerts #59 & #60 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/785
* chore(vscode): bump version to 0.4.2 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/786
* fix: allow concurrent sync when different server URLs are configured by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/787
* chore: bump vscode-extension version to 0.4.3 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/788
* fix: still run sharing server sync when Azure sync fails by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/789
* fix: deduplicate requestId in buildTurns to fix Cowork token over-count by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/790
* chore(vscode): bump version to 0.4.4 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/791
* Add missing friendly display names for 13 tools by @Copilot in https://github.com/rajbos/ai-engineering-fluency/pull/795
* Add missing friendly display names for 6 tools by @Copilot in https://github.com/rajbos/ai-engineering-fluency/pull/794
* Add Mistral AI model pricing and token estimators by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/796
* Add explainer video link to README by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/797
* fix: prevent duplicate loading sessions in status bar by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/798
* feat: Session Efficiency view - PR/session linking with scatter chart by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/799
* chore: release VS Code extension v0.5.0 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/800
* chore: release VS Code extension v0.5.0 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/801
...
* gradle(deps): bump gradle-wrapper from 8.10.2 to 9.5.0 in /jetbrains-plugin by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/751


**Full Changelog**: https://github.com/rajbos/ai-engineering-fluency/compare/cli/v0.0.8...vscode/v0.5.0
